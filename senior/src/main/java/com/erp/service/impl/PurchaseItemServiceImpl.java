...
//        String recipient = userMapper.getUserMail(map.get("supplierBehalfId"));
//        String object = MailState.AFFIRM_SUPPLIER.getDescription();
//        String content = "您参与的采购项目：[" + map.get("purchaseItemName") + "]已被确认，请尽快处理！";
//        ThreadUtil.execute(new MailSender(recipient,object,content));
